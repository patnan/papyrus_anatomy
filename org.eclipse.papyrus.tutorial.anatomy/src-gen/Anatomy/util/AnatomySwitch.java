...
public class AnatomySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnatomyPackage.WORK_PART: {
				WorkPart workPart = (WorkPart)theEObject;
				T result = caseWorkPart(workPart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnatomyPackage.BLOCKS: {
				Blocks blocks = (Blocks)theEObject;
				T result = caseBlocks(blocks);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnatomyPackage.RELATIONSHIP: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Work Part</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Work Part</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWorkPart(WorkPart object) {
		return null;
	}
