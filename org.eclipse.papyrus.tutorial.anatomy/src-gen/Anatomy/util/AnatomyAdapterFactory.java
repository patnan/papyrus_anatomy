...
public class AnatomyAdapterFactory extends AdapterFactoryImpl {
	...
	protected AnatomySwitch<Adapter> modelSwitch =
		new AnatomySwitch<Adapter>() {
			@Override
			public Adapter caseWorkPart(WorkPart object) {
				return createWorkPartAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Anatomy.WorkPart <em>Work Part</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createWorkPartAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link Anatomy.Blocks <em>Blocks</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link Anatomy.Relationship <em>Relationship</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
